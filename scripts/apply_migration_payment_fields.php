<?php
/**
 * Script para aplicar a migration de campos de pagamento na tabela orders
 */

require_once __DIR__ . '/../config/database.php';

echo "=== Aplicando Migration: payment_fields_to_orders ===\n\n";
...
// Ler a migration
$migrationFile = __DIR__ . '/../database/migrations/20251114_add_payment_fields_to_orders.sql';
